...
class Nom(models.Model):
    ...
    acct_type = models.ForeignKey(AcctType, models.DO_NOTHING, db_column='acct_type', blank=True, null=True, related_name='+')
...
class NomLc(models.Model):
    acct = models.ForeignKey(Nom, models.DO_NOTHING, primary_key=True, related_name='+')
...
class Party(models.Model):
    ...
    reg = models.ForeignKey('Regions', models.DO_NOTHING, related_name='+')
...
class PartyAdd(models.Model):
    party = models.ForeignKey(Party, models.DO_NOTHING, related_name='+')
...
class PayMode(models.Model):
    ...
    comp = models.ForeignKey(Company, models.DO_NOTHING, related_name='+')
    disb = models.CharField(max_length=1, blank=True, null=True)
    acct = models.ForeignKey(Nom, models.DO_NOTHING, blank=True, null=True)
    inhand_acct = models.ForeignKey(Nom, models.DO_NOTHING, blank=True, null=True, related_name='+')
    collect_acct = models.ForeignKey(Nom, models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class PlInvoice(models.Model):
    ...
    comp = models.ForeignKey('Po', models.DO_NOTHING, related_name='%(class)s_comp')
    year = models.ForeignKey('Po', models.DO_NOTHING, related_name='%(class)s_year_created')
    loc_id = models.CharField(max_length=2)
    dc_acct_id = models.CharField(max_length=10, blank=True, null=True)
    veh_no = models.CharField(max_length=30, blank=True, null=True)
    po = models.ForeignKey('Po', models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class PlInvoicedet(models.Model):
    ...
    prod = models.ForeignKey('SlProduct', models.DO_NOTHING, related_name='+')
...
class PlReceiptdet(models.Model):
    rec = models.ForeignKey(PlReceipt, models.DO_NOTHING, related_name='+')
    lineitem = models.CharField(max_length=3)
    ...
    comp = models.ForeignKey(PlReceipt, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(PlReceipt, models.DO_NOTHING, related_name='+')
    acct_id_cs = models.CharField(max_length=10, blank=True, null=True)
...
class PlReceiptdetAcct(models.Model):
    rec = models.ForeignKey(PlReceiptdet, models.DO_NOTHING, related_name='+')
    lineitem = models.ForeignKey(PlReceiptdet, models.DO_NOTHING, db_column='lineitem', related_name='+')
    ...
    comp = models.ForeignKey(PlReceiptdet, models.DO_NOTHING, related_name='+')
    slip_no = models.CharField(max_length=30, blank=True, null=True)
    wo_id = models.CharField(max_length=5, blank=True, null=True)
    o_bal = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    year = models.ForeignKey(PlReceiptdet, models.DO_NOTHING, related_name='+')
    ...
    cur = models.ForeignKey(Currency, models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class Prod(models.Model):
    ...
    prod = models.ForeignKey('SlProduct', models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class ProdCat(models.Model):
    ...
    acct_id_cs = models.ForeignKey(Nom, models.DO_NOTHING, db_column='acct_id_cs', blank=True, null=True, related_name='+')
    acct_id = models.CharField(max_length=10, blank=True, null=True)
...
class Proddet(models.Model):
    p = models.ForeignKey(Prod, models.DO_NOTHING, related_name='+')
    lineitem = models.CharField(max_length=2)
    prod = models.ForeignKey('SlProduct', models.DO_NOTHING, related_name='+')
    qty = models.DecimalField(max_digits=13, decimal_places=3)
    rate = models.DecimalField(max_digits=13, decimal_places=6, blank=True, null=True)
    itemtot = models.DecimalField(max_digits=13, decimal_places=2, blank=True, null=True)
    comp = models.ForeignKey(Prod, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(Prod, models.DO_NOTHING, related_name='+')
...
class Reports(models.Model):
    ...
    cat = models.IntegerField(max_length=1)
...
class SlDc(models.Model):
    ...
    st_amt = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    dc_amt = models.IntegerField(blank=True, null=True)
    party = models.ForeignKey(PartyAdd, models.DO_NOTHING, related_name='+')
    ...
    sin_desc = models.CharField(max_length=50, blank=True, null=True)
    dc_desc = models.CharField(max_length=50, blank=True, null=True)
    add = models.ForeignKey(PartyAdd, models.DO_NOTHING, blank=True, null=True, related_name='+')
    ut = models.CharField(max_length=1, blank=True, null=True)
    particulars = models.CharField(max_length=100, blank=True, null=True)
    comp = models.ForeignKey('SlPo', models.DO_NOTHING, related_name='+')
    year = models.ForeignKey('SlPo', models.DO_NOTHING, related_name='+')
    loc_id = models.CharField(max_length=2)
    dc_acct_id = models.CharField(max_length=10, blank=True, null=True)
    veh_no = models.CharField(max_length=30, blank=True, null=True)
    production = models.CharField(max_length=1, blank=True, null=True)
    ...
    po = models.ForeignKey('SlPo', models.DO_NOTHING, blank=True, null=True, related_name='+')
    credit_days = models.IntegerField(blank=True, null=True)
    ...
    vehicle = models.ForeignKey('VehicleType', models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class SlDcdet(models.Model):
    ...
    pack_rate = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    avg_rate = models.DecimalField(max_digits=15, decimal_places=6, blank=True, null=True)
    loc = models.ForeignKey(Locations, models.DO_NOTHING, related_name='+')
...
class SlInvoice(models.Model):
    ...
    sin_desc_lhr = models.CharField(max_length=50, blank=True, null=True)
    discp = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    sup = models.ForeignKey(Party, models.DO_NOTHING, blank=True, null=True, related_name='+')
    acct_id_cs = models.CharField(max_length=10, blank=True, null=True)
    net_payable = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    adv_amt = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    discount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
...
class SlInvoiceDc(models.Model):
    ...
    year = models.ForeignKey(SlDc, models.DO_NOTHING, related_name='+')
    comp = models.ForeignKey(SlDc, models.DO_NOTHING, related_name='+')
    lineitem = models.CharField(max_length=2)
    dc = models.ForeignKey(SlDc, models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class SlInvoiceRec(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    comp = models.ForeignKey(Company, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(FinYears, models.DO_NOTHING, related_name='+')
...
class SlInvoicedetBon(models.Model):
    comp = models.ForeignKey(SlInvoicedet, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(SlInvoicedet, models.DO_NOTHING, related_name='+')
    inv = models.ForeignKey(SlInvoicedet, models.DO_NOTHING, related_name='+')
    lineitem = models.ForeignKey(SlInvoicedet, models.DO_NOTHING, db_column='lineitem', related_name='+')
    ser_no = models.CharField(max_length=2)
    unit_qty = models.DecimalField(max_digits=10, decimal_places=3)
    particulars = models.CharField(max_length=30, blank=True, null=True)
...
class SlPo(models.Model):
    ...
    credit_days = models.IntegerField(blank=True, null=True)
    add_id = models.IntegerField(blank=True, null=True)
    wo = models.ForeignKey('SlWo', models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class SlPodet(models.Model):
    po = models.ForeignKey(SlPo, models.DO_NOTHING, related_name='+')
    lineitem = models.CharField(max_length=2)
    prod = models.ForeignKey('SlProduct', models.DO_NOTHING, related_name='+')
    unit_qty = models.DecimalField(max_digits=10, decimal_places=3)
    unit_rate = models.DecimalField(max_digits=10, decimal_places=3)
...
class SlPodetBon(models.Model):
    comp = models.ForeignKey(SlPodet, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(SlPodet, models.DO_NOTHING, related_name='+')
    po = models.ForeignKey(SlPodet, models.DO_NOTHING, related_name='+')
    lineitem = models.ForeignKey(SlPodet, models.DO_NOTHING, db_column='lineitem', related_name='+')
    ser_no = models.CharField(max_length=2)
    unit_qty = models.DecimalField(max_digits=10, decimal_places=3)
    particulars = models.CharField(max_length=30, blank=True, null=True)
...
class SlProduct(models.Model):
    ...
    cat = models.ForeignKey(ProdType, models.DO_NOTHING, related_name='+')
    type = models.ForeignKey(ProdType, models.DO_NOTHING, related_name='+')
...
class SlReceiptdet(models.Model):
    rec = models.ForeignKey(SlReceipt, models.DO_NOTHING, related_name='+')
    lineitem = models.CharField(max_length=3)
    r_no = models.CharField(max_length=10, blank=True, null=True)
    v_no = models.CharField(max_length=10, blank=True, null=True)
    party = models.ForeignKey(Party, models.DO_NOTHING, related_name='+')
    particulars = models.CharField(max_length=100, blank=True, null=True)
    r_date = models.DateField(blank=True, null=True)
    acct = models.ForeignKey(Nom, models.DO_NOTHING, blank=True, null=True, related_name='+')
    amount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    inv_no = models.CharField(max_length=5, blank=True, null=True)
    comp = models.ForeignKey(SlReceipt, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(SlReceipt, models.DO_NOTHING, related_name='+')
    insert_date = models.DateField()
    o_bal = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    acct_id_cs = models.CharField(max_length=10, blank=True, null=True)
...
class SlReceiptdetAcct(models.Model):
    ...
    chq_no = models.CharField(max_length=20, blank=True, null=True)
    chq_date = models.DateField(blank=True, null=True)
    acct = models.ForeignKey(Nom, models.DO_NOTHING, related_name='+')
    acct_date = models.DateField(blank=True, null=True)
    comp_id = models.CharField(max_length=2)
    slip_no = models.CharField(max_length=30, blank=True, null=True)
    wo = models.ForeignKey('SlWo', models.DO_NOTHING, blank=True, null=True, related_name='+')
    o_bal = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    year_id = models.CharField(max_length=2)
    sp = models.ForeignKey('Sp', models.DO_NOTHING, blank=True, null=True, related_name='+')
    clear_date = models.DateField(blank=True, null=True)
    inhand_acct = models.ForeignKey(Nom, models.DO_NOTHING, blank=True, null=True, related_name='+')
    collect_acct = models.ForeignKey(Nom, models.DO_NOTHING, blank=True, null=True, related_name='+')
    bounce_date = models.DateField(blank=True, null=True)
...
class SlWo(models.Model):
    ...
    div = models.ForeignKey(Division, models.DO_NOTHING, blank=True, null=True, related_name='+')
    city = models.ForeignKey(City, models.DO_NOTHING, blank=True, null=True, related_name='+')
...
class Voucher(models.Model):
    ...
    upd_date = models.DateField(blank=True, null=True)
    upd_emp_id = models.CharField(max_length=8, blank=True, null=True)
    acct_id_cs_1 = models.ForeignKey(Nom, models.DO_NOTHING, db_column='acct_id_cs_1', blank=True, null=True, related_name='+')
    acct_id_cs_2 = models.ForeignKey(Nom, models.DO_NOTHING, db_column='acct_id_cs_2', blank=True, null=True, related_name='+')
    bilty_no = models.ForeignKey(SlDc, models.DO_NOTHING, db_column='bilty_no', blank=True, null=True, related_name='+')
...
class Voucherdet(models.Model):
    voucher = models.ForeignKey(Voucher, models.DO_NOTHING, related_name='+')
    ...
    exp_id = models.CharField(max_length=7, blank=True, null=True)
    sp_exp_id = models.CharField(max_length=10, blank=True, null=True)
    comp = models.ForeignKey(Voucher, models.DO_NOTHING, related_name='+')
    year = models.ForeignKey(Voucher, models.DO_NOTHING, related_name='+')
