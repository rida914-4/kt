...
class Positions(models.Model):
    pos_code = models.CharField(primary_key=True, max_length=10)
    description = models.CharField(max_length=100, blank=True, null=True)
...
class TmpPlInvoice(models.Model):
    voucher_id = models.CharField(primary_key=True, max_length=10)
    voucher_date = models.DateField(blank=True, null=True)
    acct = models.ForeignKey(Item, models.DO_NOTHING, blank=True, null=True)
    net_amt = models.FloatField(blank=True, null=True)
    particulars = models.CharField(max_length=200, blank=True, null=True)
    post_date = models.DateField(blank=True, null=True)
    address = models.CharField(max_length=200, blank=True, null=True)
    ...
    cust = models.ForeignKey(Custodian, models.DO_NOTHING, blank=True, null=True)
...
class TmpPlInvoicedet(models.Model):
    stock_code = models.ForeignKey(Item, models.DO_NOTHING, db_column='stock_code',  blank=True, null=True)
